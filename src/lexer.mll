...
| ">="				{ GREATEREQUAL ({value=">="; pos=lexbuf.Lexing.lex_start_p}) }
| "="			    { EQ     	   ({value="=" ; pos=lexbuf.Lexing.lex_start_p}) }
| "->"			    { ARROW	   	   ({value="->"; pos=lexbuf.Lexing.lex_start_p})}
...
| ";;"				{ DBSEMI	   ({value=";;" ; pos=lexbuf.Lexing.lex_start_p})}
